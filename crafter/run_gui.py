...
import crafter
def draw_coordinates(screen, displayed_text):
    print(displayed_text)
    font = pygame.font.Font(None, 35)
    # create the text
    text = font.render(displayed_text,0, (100, 100, 100))
    # create the text's rectangle
    textpos = text.get_rect(centerx=screen.get_width() / 2, centery=screen.get_height()-20)
...
def main():
    ...
    while running:
        ...
        # draw #
        pos = env._player.pos
        draw_coordinates(screen=screen,displayed_text=str(pos))
